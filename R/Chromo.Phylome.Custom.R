#' Chromo.Phylome.Custom: function to infer a chromosome-specific set of phylogenetic trees
#'
...
#########################
# Chromo.Phylome.Custom #
#########################
Chromo.Phylome.Custom <- function(string.PathParentDir, string.PathToFastaFile, matrix.WindowCoordinates, string.Commands_iqtree){
  ...
  ####################################
  string.Path_File_CheckPoints_Results <- paste0(string.Path_ParenDir_PPD_Experiment, '/Results_CheckPoint_CUSTOM.txt')
  ...
  matrix.Experimental_WindowCoordinates <- matrix.WindowCoordinates
